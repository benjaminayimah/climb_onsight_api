                                ...
                                <div class="body-card" style="background-color: #fff; padding: 30px; border-radius: 16px">
                                    ...
                                    <div style="padding: 12px 0">
                                        <span style="color: #000; padding-bottom: 6px; font-weight: 600; font-size: 25px; display:inline-block">
                                            Sorry, your booking has been canceled by the guide
                                        </span>
                                    </div>
                                    <div style="color: rgb(34, 34, 34);">
                                        ...
                                        <p>
                                            We are sorry to inform you that your booking was canceled by the organizers of the trip. This may be due to weather concerns or circumstances beyond their control. 
                                        </p>
                                        <p>
                                           Please fill free to explore other events.
                                        </p>
                                        <p>
                                            <a href="{{ $frontend_url }}" target="_blank" class="btn" style="background-color: #000; border-radius: 18px; text-align: center; color:#fff; display:block; padding: 14px 24px; text-decoration: none; margin: 32px 24px">Explore more events</a>
                                        </p>
                                        <p>
                                            Thank you for choosing us, and we look forward to seeing you again!
                                        </p>
